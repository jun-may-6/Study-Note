...
@ControllerAdvice   //하위의 익셉션이 전역적으로 발생
public class ExceptionController {
    ...
    public ResponseEntity<ErrorResponse> handleUserException(UserNotFoundException e){
        ...
        return new ResponseEntity<>(new ErrorResponse(code, description, detail), HttpStatus.NOT_FOUND);    //body, 404
    }
        ...
        if(e.getBindingResult().hasErrors()) {
            ...
            switch(bindResultCode) {
                ...
                case "NotBlank" :
                    ...
                    description = "필수 값이 공백으로 처리되었습니다."; break;
                case "Size" :
                    code = "ERROR_CODE_00003";
                    description = "알맞은 크기의 값이 입력되지 않았습니다."; break;
            }
        }

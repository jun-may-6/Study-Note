...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 모든 메소드는 static 메소드로 작성되어있다.*/
        ...
        /* Math 클래스는 java.lang 패키지에 속하였기 때문에 import 하지 않아도 사용할 수 있다.*/

        System.out.println("-1.5의 절대값 : " + Math.abs(-1.5));

        System.out.println("10과 20중 더 작은 것? : " + Math.min(10,20));
        System.out.println("20과 30중 더 큰 것? : " + Math.max(20,30));

        System.out.println("원주울 " + Math.PI);

        /* 난수 출력
        * 0부터 1 전까지의 실수 형태의 난수를 발생*/
